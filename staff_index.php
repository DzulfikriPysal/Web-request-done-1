...
<div class="container" style="margin-top:50px;">
		...
		<div class="row">
			...
			<div class="input-field col s8 offset-s1">
				...
				<div class="carousel carousel-slider">
					<a class="carousel-item" href="#one!"><img src="image/1.jpg"></a>
					<a class="carousel-item" href="#two!"><img src="image/2.jpg"></a>
					<a class="carousel-item" href="#three!"><img src="image/6.jpg"></a>
					<a class="carousel-item" href="#four!"><img src="image/4.jpg"></a>
					<a class="carousel-item" href="#five!"><img src="image/5.jpg"></a>
				</div>
	...
	<div class="parallax-container">
		<div class="parallax"><img src="image/3.jpg"></div>
    </div>
	<div class="card-panel grey lighten-2 z-depth-5">
		<div class="row">
			<div class="input-field col s8 offset-s1">
